...
export default async function TenantProfilePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      <div className="rounded-3xl overflow-hidden shadow-lg border border-[#F0DADD]">
        {/* Cover banner */}
        <div
        ...
        >
          ...
          <div className="absolute top-5 right-5">
            <span className="flex items-center gap-1.5 bg-white/20 backdrop-blur-sm text-white text-xs sm:text-sm font-semibold px-3 py-1.5 rounded-full border border-white/30">
              <Icon icon="solar:key-bold" width={15} />
              Tenant
            </span>
          </div>
        </div>
        ...
        <div className="bg-white px-6 sm:px-10 lg:px-12 pb-10 sm:pb-12">
            ...
            <div className="relative">
              {image ? (
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #A61C3C 0%, #4A0E1A 100%)",
                  }}
                >
            ...
            <div className="flex items-center justify-center sm:justify-start gap-3 flex-wrap">
              ...
              {role && (
                <Chip
                  size="md"
                  variant="flat"
                  className="capitalize bg-[#FBE7EA] text-[#8C1C2B] font-medium text-sm"
                >
                  {role}
                </Chip>
              )}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mt-10 sm:mt-12">
            <div className="flex items-center gap-4 bg-default-50 hover:bg-[#FDF2F3] transition-colors rounded-2xl p-5 sm:p-6">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-[#FBE7EA] flex items-center justify-center shrink-0">
                <Icon
